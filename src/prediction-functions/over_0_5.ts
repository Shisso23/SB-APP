...
export const predictOver0_5 = ({
    ...
    const predictedFixtures = currentFixtures.filter(currentFixture => {
      ...
      return (homeTeamGoalsPercentage({homeTeamStanding})>= 120 && awayTeamGoalsPercentage({awayTeamStanding})>=120) && fixtureH2hFixtures.every(fixture=> fixture.goals.away + fixture.goals.home > 2);
    });
    return {
