...
export const predictOver2_5 = ({
    ...
    const predictedFixtures = currentFixtures.filter(currentFixture => {
      ...
      return (homeTeamGoalsPercentage({homeTeamStanding})>= 180 && awayTeamGoalsPercentage({awayTeamStanding})>=200) && againstHomeTeamGoalsPercentage({homeTeamStanding})>=110 && againstAwayTeamGoalsPercentage({awayTeamStanding})>=110
    });
    return {
