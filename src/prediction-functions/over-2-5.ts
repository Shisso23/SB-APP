...
import { getLastFiveHomeTeamHomeFixtures, awayTeamGoalsPercentage, homeTeamGoalsPercentage, getAwayTeamStanding, getHomeTeamStanding, getLastFiveAwayTeamAwayFixtures, getH2HFixtures, hasNoNilNilInFixtures } from "./shared-functions";
...
export const predictOver2_5 = ({
    ...
    const predictedFixtures = currentFixtures.filter(currentFixture => {
      ...
      return (homeTeamGoalsPercentage({homeTeamStanding})>= 180 && awayTeamGoalsPercentage({awayTeamStanding})>=200) 
    });
    return {
