...
export const predictUnder2_5 = ({
    ...
    const predictedFixtures = currentFixtures.filter(currentFixture => {
      ...
      return ((sharedFunctions.teamMax2({teamAAverageGoalsScored:homeTeamAverageGoalsScored, teamBAverageGoalsConceded: awayTeamAverageGoalsConceded})) &&
    ...
    return {
      ...
      option: betOptions.find(option => option.id === betOptionsEnum.TOTAL_UNDER_2_5) as betOptionModel,
    };
  };